...
<!-- #region citation-manager={"citations": {"3uvy6": [{"id": "16470964/L3YX7GNF", "source": "zotero"}], "dqlr9": [{"id": "16470964/DM72ISLW", "source": "zotero"}], "m9rta": [{"id": "16470964/UL4A3IFU", "source": "zotero"}], "nwemx": [{"id": "16470964/XR2AYGXJ", "source": "zotero"}], "p1jqs": [{"id": "16470964/VRE8WZEV", "source": "zotero"}], "xe9wj": [{"id": "16470964/A7PZLB6B", "source": "zotero"}]}} editable=true slideshow={"slide_type": ""} -->
The Rijksmuseum in Amsterdam has been widely recognised as a pioneering institution in making cultural heritage openly accessible to researchers and the wider public (<cite id="dqlr9"><a href="#zotero%7C16470964%2FDM72ISLW">(Terras, 2015)</a></cite>; <cite id="p1jqs"><a href="#zotero%7C16470964%2FVRE8WZEV">(Rühse, 2017)</a></cite>). This initiative provided impetus and became a starting point for the Open GLAM movement, as museums across the globe began making their collections available under open licenses (<cite id="3uvy6"><a href="#zotero%7C16470964%2FL3YX7GNF">(McCarthy, 2019)</a></cite>; <cite id="xe9wj"><a href="#zotero%7C16470964%2FA7PZLB6B">(Wallace, 2020)</a></cite>). Openness as a concept has a wide range of angles and may include open access, open data, open licensing and re-use, open methods, documentation, reproducibility, open participation and co-creation, and others (<cite id="m9rta"><a href="#zotero%7C16470964%2FUL4A3IFU">(Arthur et al., 2024)</a></cite>;<cite id="nwemx"><a href="#zotero%7C16470964%2FXR2AYGXJ">(Cao, 2024)</a></cite>). Therefore, considering these aspects and the historical trajectory of their implementation and the development of openness in the museums is important for understanding and mapping the complexity of openness.
<!-- #endregion -->

<!-- #region citation-manager={"citations": {"3degx": [{"id": "16470964/GF4H29Z5", "source": "zotero"}], "mkbhu": [{"id": "16470964/6XPENT4I", "source": "zotero"}], "pozva": [{"id": "16470964/4MG9A6DG", "source": "zotero"}], "rqzqq": [{"id": "16470964/AMCN83R4", "source": "zotero"}], "zsxmq": [{"id": "16470964/BKAVL42T", "source": "zotero"}]}} editable=true slideshow={"slide_type": ""} -->
The digital transformation of the Dutch museums can be traced back to 1969, when the government significantly subsidised the museum sector, favouring the first wave of digitisation (<cite id="zsxmq"><a href="#zotero%7C16470964%2FBKAVL42T">(Navarrete, 2014)</a></cite>). This step and the underlying initiatives contributed to the preparation of the digital infrastructure, which subsequently expanded. Some milestones of openness, specific to the digital domain, are located on the timeline, mapping the release of a substantial portions of its resources into the public domain under a Creative Commons Zero (CC0) license since 2011; the publication of its digital collections as Linked Open Data (<cite id="mkbhu"><a href="#zotero%7C16470964%2F6XPENT4I">(DijkshoornChris et al., 2018)</a></cite>); the promotion of use and reuse of its digital collections in high resolution through initiatives such as the Rijksawards and the Rijksstudio (<cite id="3degx"><a href="#zotero%7C16470964%2FGF4H29Z5">(Volkers, 2017)</a></cite>); and the development of tools for data search and exploration (<cite id="rqzqq"><a href="#zotero%7C16470964%2FAMCN83R4">(Mensink &#38; van Gemert, 2014)</a></cite>), alongside other projects. In Figure 1, you may see these milestones indicated on the timeline. By today, the Rijksmuseum made 823,077 artworks, 348,151 library items, and 196,648 visitor stories publicly available online (<cite id="pozva"><a href="#zotero%7C16470964%2F4MG9A6DG">(<i>Search the Collection</i>, n.d.)</a></cite>).
<!-- #endregion -->
...
1) Datasets and other resources available on the museum’s website;  

<!-- #region citation-manager={"citations": {"j20ub": [{"id": "16470964/4K3VW4GC", "source": "zotero"}]}} -->
2) Relevant records published on the external platforms (such as Wikidata (<cite id="j20ub"><a href="#zotero%7C16470964%2F4K3VW4GC">(<i>Wikidata</i>, n.d.)</a></cite>)) may help to expand the data record and specify some aspects of museum objects;
<!-- #endregion -->

<!-- #region citation-manager={"citations": {"0qsrd": [{"id": "16470964/3KRW6VFT", "source": "zotero"}], "g07vo": [{"id": "16470964/VU53ZACQ", "source": "zotero"}], "lt8rv": [{"id": "16470964/5V83W63Z", "source": "zotero"}]}} -->
3) Snapshots on the web archives (Internet Archive (<cite id="g07vo"><a href="#zotero%7C16470964%2FVU53ZACQ">(<i>Internet Archive</i>, n.d.)</a></cite>)) and the Web Collection of the National Library of the Netherlands (<cite id="0qsrd"><a href="#zotero%7C16470964%2F3KRW6VFT">(De Bode &#38; Teszelszky, 2021)</a></cite>; <cite id="lt8rv"><a href="#zotero%7C16470964%2F5V83W63Z">(P. De Bode et al., 2021)</a></cite>). The web-archived collections are necessary to identify the records that have been preserved and, therefore, made available as historical materials for study.
<!-- #endregion -->
...
<!-- #region citation-manager={"citations": {"8s0wb": [{"id": "16470964/SISDP89V", "source": "zotero"}]}} -->
Study of museums on the web using web archives is a highly interdisciplinary field that combines museology, history, information science, web archiving, and other perspectives (<cite id="8s0wb"><a href="#zotero%7C16470964%2FSISDP89V">(de Wild &#38; Povroznik, 2024)</a></cite>). Exploring museums' web presence from a historical perspective is mainly possible through web archives, because these platforms are dedicated to preserving and representing the past web. Web archives preserve unique snapshots of the museum’s online presence, serving as a historical record invaluable for such study. These repositories, particularly the Internet Archive and the National Library of the Netherlands (the Koninklijke Bibliotheek, KB), which contributes to the preservation of the Dutch web by caring for the KB Web Collection, crawl websites to archive them for the future.
<!-- #endregion -->

<!-- #region citation-manager={"citations": {"16r4e": [{"id": "16470964/6XUWWZ9Q", "source": "zotero"}], "2v5dn": [{"id": "16470964/EJCXVLIR", "source": "zotero"}], "3iguc": [{"id": "16470964/2DNZ64BU", "source": "zotero"}], "68dnp": [{"id": "16470964/N7F9I4PL", "source": "zotero"}], "8c4qn": [{"id": "16470964/39UN8I6R", "source": "zotero"}], "8f09k": [{"id": "16470964/M8EFNUNU", "source": "zotero"}], "cgoib": [{"id": "16470964/E7NKRQUZ", "source": "zotero"}], "ez47s": [{"id": "16470964/YUUL7S73", "source": "zotero"}], "hidk8": [{"id": "16470964/N7F9I4PL", "source": "zotero"}], "nhtky": [{"id": "16470964/7G6ENV3E", "source": "zotero"}], "pllfs": [{"id": "16470964/JN3TFPX9", "source": "zotero"}], "vrfpr": [{"id": "16470964/U37NVKU3", "source": "zotero"}], "w5ir9": [{"id": "16470964/6PCQM2US", "source": "zotero"}]}} -->
Scholarship on web history and the use of web archives has highlighted how web archives can be treated as sources and infrastructures for historical research (<cite id="vrfpr"><a href="#zotero%7C16470964%2FU37NVKU3">(Balbi, 2025)</a></cite>);<cite id="8c4qn"><a href="#zotero%7C16470964%2F39UN8I6R">(Brügger, 2018)</a></cite>; <cite id="8f09k"><a href="#zotero%7C16470964%2FM8EFNUNU">(Schroeder &#38; Brügger, 2017)</a></cite>; <cite id="hidk8"><a href="#zotero%7C16470964%2FN7F9I4PL">(Weber, 2018)</a></cite>) and has provided methodological foundations for studying the museums' web (<cite id="cgoib"><a href="#zotero%7C16470964%2FE7NKRQUZ">(Skov &#38; Svarre, 2024)</a></cite>; <cite id="2v5dn"><a href="#zotero%7C16470964%2FEJCXVLIR">(Povroznik, 2025)</a></cite>). Scholars and web archivists also stressed the limitations of web archives for research (<cite id="16r4e"><a href="#zotero%7C16470964%2F6XUWWZ9Q">(Ben-David &#38; Huurdeman, 2014)</a></cite>; <cite id="nhtky"><a href="#zotero%7C16470964%2F7G6ENV3E">(Maemura, 2018)</a></cite>). These discussions are especially relevant for examining websites, as their digital prints are shaped by fragmented preservation, selection policies of web archives, their technical capacities, priorities and approaches to preservation in general and retrieval issues (<cite id="ez47s"><a href="#zotero%7C16470964%2FYUUL7S73">(Brügger &#38; Laursen, 2020)</a></cite>; <cite id="3iguc"><a href="#zotero%7C16470964%2F2DNZ64BU">(Winters &#38; Prescott, 2019)</a></cite>). Such factors determine which portions of the web’s past are captured and what will consequently be accessible to other generations and available for research. Therefore, the web study should necessarily integrate source criticism in the work. As a fundamental practice in historical research, source criticism is a necessary step for evaluating this source base and for determining what kinds of research questions we, as researchers, can raise. The questions of accuracy and completeness of web archive data must also be addressed (<cite id="pllfs"><a href="#zotero%7C16470964%2FJN3TFPX9">(Brügger, 2012)</a></cite>; <cite id="68dnp"><a href="#zotero%7C16470964%2FN7F9I4PL">(Weber, 2018)</a></cite>; <cite id="w5ir9"><a href="#zotero%7C16470964%2F6PCQM2US">(Ben-David &#38; Amram, 2019)</a></cite>).
<!-- #endregion -->
...
<!-- #region citation-manager={"citations": {"wicnk": [{"id": "16470964/CSTSCA42", "source": "zotero"}]}} -->
...
```python jdh={"module": "object", "object": {"source": ["Rijksmuseum: Artworks Online and Rijksstudio's Entries"]}} tags=["figure-3-*"]
import pandas as pd
...
<!-- #region citation-manager={"citations": {"kom26": [{"id": "16470964/ABIIGX4D", "source": "zotero"}]}} -->
...
<!-- #region citation-manager={"citations": {"1y6n3": [{"id": "16470964/DLVWLHZG", "source": "zotero"}], "6lbfd": [{"id": "16470964/YKDCRRJB", "source": "zotero"}], "9d5ln": [{"id": "16470964/YKDCRRJB", "source": "zotero"}], "fobcc": [{"id": "16470964/UXMZXQBE", "source": "zotero"}]}} -->
To assess the results of object number extraction, the experiment compared the object numbers captured by the crawling institutions with the current museum's database. The Rijksmuseum publishes various datasets on its website for public access (<cite id="fobcc"><a href="#zotero%7C16470964%2FUXMZXQBE">(<i>Rijksmuseum Data Services</i>, n.d.)</a></cite>). Data, provided by the museum, includes the data dumps from different domains (including the museum’s collection and library (<cite id="1y6n3"><a href="#zotero%7C16470964%2FDLVWLHZG">(<i>Data Dumps | Rijksmuseum Data Services</i>, n.d.)</a></cite>)). The website also suggests historical data dumps, which provide metadata from 2019 and 2020 (<cite id="9d5ln"><a href="#zotero%7C16470964%2FYKDCRRJB">(<i>Historical Data Dumps | Rijksmuseum Data Services</i>, n.d.)</a></cite>). Newly published datasets include information about each object, located in separate files, which makes them difficult to explore in bulk. For the experiment, the most recent consistent dataset, organised in a single csv file, dates back to January 2020. It was downloaded from Historical Data Dumps marked as ‘Comma Separated Values object metadata download’ (<cite id="6lbfd"><a href="#zotero%7C16470964%2FYKDCRRJB">(<i>Historical Data Dumps | Rijksmuseum Data Services</i>, n.d.)</a></cite>) and used in the experiment. 
<!-- #endregion -->
...
However, it was discovered on Wikimedia as the “File:Kaïn en Abel Rijksmuseum SK-A-3507.jpeg”, titled in summary as “Willem de Zwart: Kaïn en Abel” and labelled by 'accession number' SK-A-3507. Also, the description indicated that the painting belonged to the Rijksmuseum collection (<cite id="cx4a4"><a href="#zotero%7C16470964%2FECDVEF9E">(<i>File:Kaïn En Abel Rijksmuseum SK-A-3507.Jpeg</i>, n.d.)</a></cite>). This finding raises questions about the museum's documentation practices, as it is not yet transparent at the moment whether the painting remains in the collection. It was not found on the Rijksmuseum collection online under the title or in the collection devoted to the painter, Willem de Zwart.
<!-- #endregion -->
...
<!-- #region citation-manager={"citations": {"nmbt2": [{"id": "16470964/89MVQTWX", "source": "zotero"}]}} editable=true slideshow={"slide_type": ""} tags=["hermeneutics"] -->
The preprocessing and cleaning steps involve an additional methodological limitation. In particular, deduplication based on CDX “digest” values can produce false negatives (<cite id="nmbt2"><a href="#zotero%7C16470964%2F89MVQTWX">(<i>Internet Archive Forums: CDX Digest Not Accurately Capturing Duplicates?</i>, 2014)</a></cite>), for example, by identifying captures as distinct even when they represent duplicates. This issue, acknowledged by the Internet Archive, may affect counts and the data. In the study, the effect is expected to be mild and does not alter the main qualitative patterns, but it should be taken into account in further steps.
<!-- #endregion -->
...
<div class="csl-bib-body">
  <div class="csl-entry"><i id="zotero|16470964/UL4A3IFU"></i>Arthur, P. L., Hearn, L., Smith, I., &#38; Koutras, N. (2024). How “open” are Australian museums? A review through the lens of copyright governance. <i>Internet Histories</i>, <i>8</i>(1–2), 136–152. <a href="https://doi.org/10.1080/24701475.2023.2268375">https://doi.org/10.1080/24701475.2023.2268375</a></div>
  ...
  <div class="csl-entry"><i id="zotero|16470964/6PCQM2US"></i>Ben-David, A., &#38; Amram, A. (2019). Computational Methods for Web History. In <i>N. Brügger, I. Milligan (Eds.) Computational methods for web history (pp. 153-167). SAGE Publications Ltd</i>. <a href="https://doi.org/10.4135/9781526470546">https://doi.org/10.4135/9781526470546</a></div>
  <div class="csl-entry"><i id="zotero|16470964/6XUWWZ9Q"></i>Ben-David, A., &#38; Huurdeman, H. (2014). Web Archive Search as Research: Methodological and Theoretical Implications. <i>Alexandria</i>, <i>25</i>(1–2), 93–111. <a href="https://doi.org/10.7227/ALX.0022">https://doi.org/10.7227/ALX.0022</a></div>
  <div class="csl-entry"><i id="zotero|16470964/JN3TFPX9"></i>Brügger, N. (2012). Web History and the Web as a Historical Source. <i>Zeithistorische Forschungen/Studies in Contemporary History, Online-Ausgabe</i>, <i>9</i>, 316–325. <a href="https://doi.org/10.14765/ZZF.DOK-1588">https://doi.org/10.14765/ZZF.DOK-1588</a></div>
  <div class="csl-entry"><i id="zotero|16470964/39UN8I6R"></i>Brügger, N. (2018). <i>The Archived Web: Doing History in the Digital Age</i>. The MIT Press. <a href="https://doi.org/10.7551/mitpress/10726.001.0001">https://doi.org/10.7551/mitpress/10726.001.0001</a></div>
  <div class="csl-entry"><i id="zotero|16470964/YUUL7S73"></i>Brügger, N., &#38; Laursen, D. (2020). Introduction. In <i>The Historical Web and Digital Humanities: The Case of National Web Domains</i>. Routledge &#38; CRC Press. <a href="https://www.routledge.com/The-Historical-Web-and-Digital-Humanities-The-Case-of-National-Web-Domains/Brugger-Laursen/p/book/9780367671181">https://www.routledge.com/The-Historical-Web-and-Digital-Humanities-The-Case-of-National-Web-Domains/Brugger-Laursen/p/book/9780367671181</a></div>
  <div class="csl-entry"><i id="zotero|16470964/XR2AYGXJ"></i>Cao, T. L. (2024). <i>Cao, T. L. (2023). Rethinking openness: a social constructivist approach to the promises of the new museology. Internet Histories, 8(1–2), 114–135. https://doi.org/10.1080/24701475.2023.2244341</i>. <a href="https://www.tandfonline.com/doi/full/10.1080/24701475.2023.2244341">https://www.tandfonline.com/doi/full/10.1080/24701475.2023.2244341</a></div>
  <div class="csl-entry"><i id="zotero|16470964/DLVWLHZG"></i><i>Data Dumps | Rijksmuseum Data Services</i>. (n.d.). Rijksmuseum. Retrieved November 18, 2025, from <a href="https://data.rijksmuseum.nl/docs/data-dumps/">https://data.rijksmuseum.nl/docs/data-dumps/</a></div>
  <div class="csl-entry"><i id="zotero|16470964/3KRW6VFT"></i>De Bode, P., &#38; Teszelszky, K. (2021). <i>Collectiebeschrijving XS4ALL-homepages</i>. Zenodo. <a href="https://doi.org/10.5281/ZENODO.5055570">https://doi.org/10.5281/ZENODO.5055570</a></div>
  <div class="csl-entry"><i id="zotero|16470964/SISDP89V"></i>de Wild, K., &#38; Povroznik, N. (2024). Editorial: Museums on the Web. <i>Internet Histories</i>, <i>8</i>(1–2), 1–8. <a href="https://doi.org/10.1080/24701475.2024.2346870">https://doi.org/10.1080/24701475.2024.2346870</a></div>
  <div class="csl-entry"><i id="zotero|16470964/6XPENT4I"></i>DijkshoornChris, JongmaLizzy, AroyoLora, OssenbruggenJacco,  van, SchreiberGuus, WeeleWesley,  ter, &#38; WielemakerJan. (2018). The Rijksmuseum collection as Linked Data. <i>Semantic Web</i>. <a href="https://doi.org/10.3233/SW-170257">https://doi.org/10.3233/SW-170257</a></div>
  <div class="csl-entry"><i id="zotero|16470964/LSI6BGG4"></i><i>FAQ about the Strategy for the formation of the National Library collection 2024-2030 | KB, National Library of the Netherlands</i>. (n.d.). Retrieved January 16, 2026, from <a href="https://www.kb.nl/en/faq-about-strategy-formation-national-library-collection-2024-2030">https://www.kb.nl/en/faq-about-strategy-formation-national-library-collection-2024-2030</a></div>
  <div class="csl-entry"><i id="zotero|16470964/ECDVEF9E"></i><i>File:Kaïn en Abel Rijksmuseum SK-A-3507.jpeg</i>. (n.d.). Rijksmuseum. Retrieved January 15, 2026, from <a href="https://commons.wikimedia.org/wiki/File:Ka%C3%AFn_en_Abel_Rijksmuseum_SK-A-3507.jpeg">https://commons.wikimedia.org/wiki/File:Ka%C3%AFn_en_Abel_Rijksmuseum_SK-A-3507.jpeg</a></div>
  <div class="csl-entry"><i id="zotero|16470964/YKDCRRJB"></i><i>Historical Data Dumps | Rijksmuseum Data Services</i>. (n.d.). Rijksmuseum. Retrieved November 18, 2025, from <a href="https://data.rijksmuseum.nl/docs/data-dumps/historical-dumps">https://data.rijksmuseum.nl/docs/data-dumps/historical-dumps</a></div>
  <div class="csl-entry"><i id="zotero|16470964/VU53ZACQ"></i><i>Internet Archive</i>. (n.d.). <a href="https://archive.org">https://archive.org</a></div>
  <div class="csl-entry"><i id="zotero|16470964/89MVQTWX"></i><i>Internet Archive Forums: CDX digest not accurately capturing duplicates?</i> (2014). <a href="https://archive.org/post/1009990/cdx-digest-not-accurately-capturing-duplicates">https://archive.org/post/1009990/cdx-digest-not-accurately-capturing-duplicates</a></div>
  <div class="csl-entry"><i id="zotero|16470964/7G6ENV3E"></i>Maemura, E. (2018). What’s cached is prologue: Reviewing recent web archives research towards supporting scholarly use. <i>Proceedings of the Association for Information Science and Technology</i>, <i>55</i>(1), 327–336. <a href="https://doi.org/10.1002/pra2.2018.14505501036">https://doi.org/10.1002/pra2.2018.14505501036</a></div>
  <div class="csl-entry"><i id="zotero|16470964/L3YX7GNF"></i>McCarthy, D. (2019). Uncovering the global picture of Open GLAM. <i>Open GLAM</i>. <a href="https://medium.com/open-glam/uncovering-the-global-picture-of-open-glam-af364aadeeee">https://medium.com/open-glam/uncovering-the-global-picture-of-open-glam-af364aadeeee</a></div>
  <div class="csl-entry"><i id="zotero|16470964/AMCN83R4"></i>Mensink, T., &#38; van Gemert, J. (2014). The Rijksmuseum Challenge: Museum-Centered Visual Recognition. <i>Proceedings of International Conference on Multimedia Retrieval</i>, 451–454. <a href="https://doi.org/10.1145/2578726.2578791">https://doi.org/10.1145/2578726.2578791</a></div>
  <div class="csl-entry"><i id="zotero|16470964/W6TNPHKL"></i>Milligan, I. (2024). <i>Averting the Digital Dark Age: How Archivists, Librarians, and Technologists Built the Web a Memory</i>. Johns Hopkins University Press. <a href="https://muse.jhu.edu/pub/1/oa_monograph/book/123276">https://muse.jhu.edu/pub/1/oa_monograph/book/123276</a></div>
  <div class="csl-entry"><i id="zotero|16470964/BKAVL42T"></i>Navarrete, T. (2014). Becoming Digital: A Dutch Heritage Perspective. <i>The Journal of Arts Management, Law, and Society</i>, <i>44</i>(3), 153–168. <a href="https://doi.org/10.1080/10632921.2014.938385">https://doi.org/10.1080/10632921.2014.938385</a></div>
  <div class="csl-entry"><i id="zotero|16470964/BXWCMWQ3"></i>OpenGlam. Case Study: Rijksmuseum releases 111.000 high quality images to the public domain. (2013). <i>OpenGlam</i>. <a href="https://openglam.org/how/">https://openglam.org/how/</a></div>
  <div class="csl-entry"><i id="zotero|16470964/5V83W63Z"></i>P. De Bode, I. Geldermans, &#38; Teszelszky, K. (2021). <i>Web collection NL-blogosfeer</i> (Version 1) [Data set]. Zenodo. <a href="https://doi.org/10.5281/ZENODO.4593479">https://doi.org/10.5281/ZENODO.4593479</a></div>
  <div class="csl-entry"><i id="zotero|16470964/EJCXVLIR"></i>Povroznik, N. (2025). History of virtual museums and web archives: Opportunities for rescaling research. In <i>The Routledge Companion to Transnational Web Archive Studies</i>. Routledge.</div>
  <div class="csl-entry"><i id="zotero|16470964/UXMZXQBE"></i><i>Rijksmuseum Data Services</i>. (n.d.). Rijksmuseum. Retrieved November 18, 2026, from <a href="https://data.rijksmuseum.nl/">https://data.rijksmuseum.nl/</a></div>
  <div class="csl-entry"><i id="zotero|16470964/CSTSCA42"></i><i>Rijksstudio. Snapshot on 23.10.2018. Internet Archive, Wayback Machine</i>. (n.d.). Retrieved January 14, 2026, from <a href="https://web.archive.org/web/20181023140058/https:/www.rijksmuseum.nl/nl/rijksstudio">https://web.archive.org/web/20181023140058/https:/www.rijksmuseum.nl/nl/rijksstudio</a></div>
  <div class="csl-entry"><i id="zotero|16470964/VRE8WZEV"></i>Rühse, V. (2017). The Digital Collection of the Rijksmuseum: Open Content and the Commercialization of a National Museum. In O. Grau (Ed.), <i>Museum and Archive on the Move: Changing Cultural Institutions in the Digital Era</i> (pp. 37–56). De Gruyter. <a href="https://www.degruyterbrill.com/document/doi/10.1515/9783110529630-003/html">https://www.degruyterbrill.com/document/doi/10.1515/9783110529630-003/html</a></div>
  <div class="csl-entry"><i id="zotero|16470964/8KIDPTAV"></i><i>Schetsen van Hokusai - deel 14</i>. (n.d.). Rijksmuseum. Retrieved January 15, 2026, from <a href="https://www.rijksmuseum.nl/en/collection/object/Schetsen-van-Hokusai-deel-14--ecfa3ecf2614bce86aa8c8829fe4981b">https://www.rijksmuseum.nl/en/collection/object/Schetsen-van-Hokusai-deel-14--ecfa3ecf2614bce86aa8c8829fe4981b</a></div>
  <div class="csl-entry"><i id="zotero|16470964/HIK6TB4G"></i>Schotel, J. C. (n.d.). <i>Lossen van tonnen op een afgemeerd zeilschip</i>. Rijksmuseum. Retrieved January 15, 2026, from <a href="https://www.rijksmuseum.nl/en/collection/object/Lossen-van-tonnen-op-een-afgemeerd-zeilschip--6efba815284d5c14057ec44c4490e157">https://www.rijksmuseum.nl/en/collection/object/Lossen-van-tonnen-op-een-afgemeerd-zeilschip--6efba815284d5c14057ec44c4490e157</a></div>
  <div class="csl-entry"><i id="zotero|16470964/M8EFNUNU"></i>Schroeder, R., &#38; Brügger, N. (2017). Introduction:: The web as history. In R. Schroeder &#38; N. Brügger (Eds.), <i>The Web as History</i> (pp. 1–20). UCL Press; JSTOR. <a href="https://doi.org/10.2307/j.ctt1mtz55k.6">https://doi.org/10.2307/j.ctt1mtz55k.6</a></div>
  <div class="csl-entry"><i id="zotero|16470964/4MG9A6DG"></i><i>Search the collection</i>. (n.d.). Rijksmuseum. Retrieved July 21, 2025, from <a href="https://www.rijksmuseum.nl/en/collection/search">https://www.rijksmuseum.nl/en/collection/search</a></div>
  <div class="csl-entry"><i id="zotero|16470964/E7NKRQUZ"></i>Skov, M., &#38; Svarre, T. (2024). A diachronic cluster analysis of Danish museum websites. <i>Internet Histories</i>, <i>8</i>(1–2), 188–203. <a href="https://doi.org/10.1080/24701475.2024.2313292">https://doi.org/10.1080/24701475.2024.2313292</a></div>
  <div class="csl-entry"><i id="zotero|16470964/DM72ISLW"></i>Terras, M. (2015). Opening Access to collections: the making and using of open digitised cultural content. <i>Online Information Review</i>, <i>39</i>(5), 733–752. <a href="https://doi.org/10.1108/OIR-06-2015-0193">https://doi.org/10.1108/OIR-06-2015-0193</a></div>
  <div class="csl-entry"><i id="zotero|16470964/GF4H29Z5"></i>Volkers, L. (2017). Image First: Opening Up the Rijksmuseum With Rijksstudio. <i>The Digital in Cultural Spaces (Singapore). Edited by T. Karthigesu, T. C. Hua, and C. - A. L. M. Gek. Singapore: Culture Academy Singapore</i>, 15–22.</div>
  <div class="csl-entry"><i id="zotero|16470964/A7PZLB6B"></i>Wallace, A. (2020). Barriers to Open Access. <i>Open GLAM</i>. <a href="https://doi.org/10.21428/74d826b1.22317341">https://doi.org/10.21428/74d826b1.22317341</a></div>
  <div class="csl-entry"><i id="zotero|16470964/ABIIGX4D"></i><i>Wayback Machine - Calendar of https://www.rijksmuseum.nl/nl/ontdek-de-collectie/overzicht/johannes-vermeer</i>. (n.d.). Retrieved January 19, 2026, from <a href="https://web.archive.org/web/20131015000000*/https://www.rijksmuseum.nl/nl/ontdek-de-collectie/overzicht/johannes-vermeer">https://web.archive.org/web/20131015000000*/https://www.rijksmuseum.nl/nl/ontdek-de-collectie/overzicht/johannes-vermeer</a></div>
  <div class="csl-entry"><i id="zotero|16470964/5LJVV378"></i><i>Wayback Machine APIs | Internet Archive</i>. (n.d.). Retrieved January 19, 2026, from <a href="https://archive.org/help/wayback_api.php">https://archive.org/help/wayback_api.php</a></div>
  <div class="csl-entry"><i id="zotero|16470964/N7F9I4PL"></i>Weber, M. S. (2018). Methods and Approaches to Using Web Archives in Computational Communication Research. <i>Communication Methods and Measures</i>, <i>12</i>(2–3), 200–215. <a href="https://doi.org/10.1080/19312458.2018.1447657">https://doi.org/10.1080/19312458.2018.1447657</a></div>
  <div class="csl-entry"><i id="zotero|16470964/4K3VW4GC"></i><i>Wikidata</i>. (n.d.). Retrieved January 13, 2026, from <a href="https://www.wikidata.org/wiki/Wikidata:Main_Page">https://www.wikidata.org/wiki/Wikidata:Main_Page</a></div>
