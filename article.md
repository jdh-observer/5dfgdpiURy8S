...
<!-- #region citation-manager={"citations": {"0qsrd": [{"id": "16470964/3KRW6VFT", "source": "zotero"}], "g07vo": [{"id": "16470964/VU53ZACQ", "source": "zotero"}], "j20ub": [{"id": "16470964/4K3VW4GC", "source": "zotero"}], "lt8rv": [{"id": "16470964/5V83W63Z", "source": "zotero"}]}} -->
However, to be able to address these questions, it is necessary to evaluate the available records. Three main cohorts of resources can be identified. They are: 1) datasets and other resources available on the museum’s website; 2) relevant records published on the external platforms (such as Wikidata (<cite id="j20ub"><a href="#zotero%7C16470964%2F4K3VW4GC">(<i>Wikidata</i>, n.d.)</a></cite>)); 3) snapshots on the web archives (Internet Archive (<cite id="g07vo"><a href="#zotero%7C16470964%2FVU53ZACQ">(<i>Internet Archive</i>, n.d.)</a></cite>)) and the Web Collection of the National Library of the Netherlands (<cite id="0qsrd"><a href="#zotero%7C16470964%2F3KRW6VFT">(De Bode &#38; Teszelszky, 2021)</a></cite>; <cite id="lt8rv"><a href="#zotero%7C16470964%2F5V83W63Z">(P. De Bode et al., 2021)</a></cite>).
<!-- #endregion -->
